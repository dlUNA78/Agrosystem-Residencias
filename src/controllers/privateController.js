...
export const createCrop = async (req, res) => {
  ...
  try {
    ...
    const crop = await db.Crop.create(
      {
        ...
        planting_density: planting_density || null,
        ...
        pollination_type: pollination_type || null,
    ...
    if (req.files && req.files.length > 0) {
      ...
      await db.CropImage.bulkCreate(images, {
        transaction,
      });
...
// ── LANDS ── Migrado a src/controllers/private/landsController.js
