export default {
  async up(queryInterface) {
    ...
    const plagueProd = [
      {
        plague_id: getPId('Cenicilla Polvorienta'),
        product_id: getProdId('Amistar Top'),
      },
      {
        plague_id: getPId('Cenicilla Polvorienta'),
        product_id: getProdId('Folicur 250 EW'),
      },
      {
        plague_id: getPId('Gusano Cogollero'),
        product_id: getProdId('Coragen'),
      },
      {
        plague_id: getPId('Gusano Cogollero'),
        product_id: getProdId('Belt 480 SC'),
      },
      {
        plague_id: getPId('Mosca del Mediterráneo'),
        product_id: getProdId('Success 120 SC'),
      },
      {
        plague_id: getPId('Psílido Asiático de los Cítricos'),
        product_id: getProdId('Confidor 350 SC'),
      },
      {
        plague_id: getPId('Psílido Asiático de los Cítricos'),
        product_id: getProdId('Movento 150 SC'),
      },
      {
        plague_id: getPId('Pulgón Verde'),
        product_id: getProdId('Confidor 350 SC'),
      },
      {
        plague_id: getPId('Pulgón Verde'),
      ...
      {
        plague_id: getPId('Roya Amarilla del Trigo'),
        product_id: getProdId('Folicur 250 EW'),
      },
      {
        plague_id: getPId('Roya Amarilla del Trigo'),
      ...
      {
        plague_id: getPId('Tizón Tardío'),
        product_id: getProdId('Ridomil Gold Bravo'),
      },
      {
        plague_id: getPId('Tizón Tardío'),
        product_id: getProdId('Amistar Top'),
      ...
      {
        plague_id: getPId('Trips Oriental'),
        product_id: getProdId('Success 120 SC'),
      },
      {
        plague_id: getPId('Trips Oriental'),
