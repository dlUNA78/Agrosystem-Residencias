        ...
        biological_cycle: JSON.stringify([
          {
            title: 'Uredosporas',
            description:
              'Esporas asexuales transportadas por el viento a grandes distancias. Germinan con humedad y temperaturas de 7–15°C.',
          },
          {
            title: 'Infección y penetración',
            description:
              'La espora penetra por los estomas en 6–8 horas con rocío. El periodo de incubación es de 7–14 días según temperatura.',
          },
          {
            title: 'Colonización',
            description:
              'El micelio coloniza el tejido intercelular. Las primeras pústulas visibles aparecen entre los 10–18 días post-infección.',
          },
          {
            title: 'Esporulación',
            description:
              'Cada pústula produce millones de uredosporas que reinician el ciclo. En una temporada pueden ocurrir múltiples ciclos de infección.',
          },
        ]),
      ...
      },
      {
        ...
        biological_cycle: JSON.stringify([
          ...
          },
          {
            ...
            description:
              'Periodo de mayor daño. Las larvas pequeñas raspan el tejido foliar; las mayores perforan el cogollo. El ciclo larval dura 14–22 días.',
          },
          {
            title: 'Pupa',
            description:
              'Se empupa en el suelo a 2–8 cm de profundidad. El periodo pupal dura 8–12 días. La labranza puede exponer y destruir pupas.',
          },
          {
            title: 'Adulto (Polilla)',
            description:
              'El adulto vive 10–21 días. Las hembras pueden migrar hasta 100 km en una noche, lo que explica la rápida dispersión regional.',
          },
        ]),
        ...
        biological_cycle: JSON.stringify([
          {
            title: 'Conidias',
            description:
              'Esporas asexuales dispersadas por el viento. Germinan directamente sobre la superficie foliar sin necesidad de agua libre.',
          },
          {
            title: 'Infección superficial',
            description:
              'El hongo coloniza solo la epidermis, proyectando haustorios al interior celular. No penetra en el mesófilo, facilitando el control químico superficial.',
          },
          {
            title: 'Colonización y esporulación',
            description:
              'El micelio blanco se extiende rápidamente. Cada mancha puede producir miles de conidias en 5–7 días, iniciando nuevos ciclos.',
          },
          {
            title: 'Cleistotecios (invierno)',
            description:
              'Estructuras sexuales negras que permanecen en residuos vegetales como inóculo para la siguiente temporada.',
          },
        ]),
