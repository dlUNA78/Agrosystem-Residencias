...
privateRouter.post("/private/crops/create", uploadCrop.array("images", 10), createCrop);       // Crear cultivo (hasta 10 imágenes)
privateRouter.post("/private/crops/update/:id", uploadCrop.array("images", 10), updateCrop);  // Actualizar cultivo
...
privateRouter.post("/private/plagues/create", uploadPlague.single("image"), createPlague);              // Crear plaga (1 imagen)
privateRouter.post("/private/plagues/update/:id", uploadPlague.single("image"), updatePlague);          // Actualizar plaga
