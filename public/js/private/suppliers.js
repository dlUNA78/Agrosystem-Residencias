document.addEventListener('DOMContentLoaded', () => {
  ...
  function openEditSupplierModal(button) {
    ...
    document.getElementById('supplier-commercial-name').value =
      data.commercialName || '';
    document.getElementById('supplier-rfc').value = data.rfc || '';
    document.getElementById('supplier-supply-type').value =
      data.supplyType || '';
    document.getElementById('supplier-contact-name').value =
      data.contactName || '';
    document.getElementById('supplier-contact-position').value =
      data.contactPosition || '';
    document.getElementById('supplier-email').value = data.email || '';
    document.getElementById('supplier-alternative-email').value =
      data.alternativeEmail || '';
    document.getElementById('supplier-phone').value = data.phone || '';
    document.getElementById('supplier-alternative-phone').value =
    ...
    document.getElementById('supplier-country').value =
      data.country || 'México';
    document.getElementById('supplier-supplied-products').value =
      data.suppliedProducts || '';
    document.getElementById('supplier-brands').value = data.brands || '';
    document.getElementById('supplier-delivery-time').value =
      data.deliveryTime || '';
    document.getElementById('supplier-minimum-order').value =
      data.minimumOrder || '';
    document.getElementById('supplier-payment-method').value =
      data.paymentMethod || '';
...
(() => {
  ...
  searchInput.addEventListener('input', () => {
    ...
    // GRID DE PROVEEDORES
    const cards = document.querySelectorAll('#suppliers-grid-view > div');
